...
tags:
  ...
  - database
  - schema
summary: "Database Schema: RAG-basierte Enterprise Knowledge Base Data Model"
read_when:
  - "Database design for knowledge-base"
  - "Writing migrations"
  - "Data privacy reviews"
---

# Database: RAG-basierte Enterprise Knowledge Base

## Schema-Übersicht

- **users** (id, email, name, created_at)
- **workspaces** (id, name, owner_id, plan, created_at)
- **knowledge-base_resources** (id, workspace_id, name, config, created_at, updated_at)

## Indizes

- `idx_knowledge-base_resources_workspace_id` auf `workspace_id`
- `idx_knowledge-base_resources_created_at` auf `created_at` ( für Time-Range Queries)
